...
public class RawDataUnitDAOImplTest {
    ...
    public void testInitialConditionsSatisfied() throws Exception {
        ...
        Training training = new Training("training1",new Date(),1,1L,1L,0,0,null,null,null,null,null);
    ...
    public void testGetInitialConditions() throws Exception {
        ...
        Training training = new Training("training2",new Date(),1,1L,1L,0,0,null,null,null,null,null);
        trainingDAO.addTraining(training);
    ...
    private void addRawDataUnits(int numb, Device device, Training training) throws Exception{
        for(int i = 0; i < numb; i++){
            ...
            RawDataUnit data = new RawDataUnit(null, listGPS,null,device,1L,false,new Date(),training);
