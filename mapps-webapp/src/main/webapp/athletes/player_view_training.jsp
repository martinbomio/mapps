...
<script type="text/javascript">
	...
	function update_values(response){
		...
		window.time_chart.validateData();
		window.pie_chart.dataProvider = window.training_zones_data;
		window.pie_chart.validateData();
	}
        ...
        <div id="main_div">
            ...
            <div id="main_div_up">
                <div id="athlete_data_div">
                    	<img src="../images/athletes/default.png" id="athlete_img" height="110px" style="float: left;margin-top: 25px;margin-left: 10px" />
                    	<div id='athlete_data'>
